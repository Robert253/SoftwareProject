...
function local_knowledgebase_before_footer() {
    global $DB, $USER;
    $sql = "SELECT lm.id, lm.messagetext, lm.messagetype 
            FROM {local_knowledgebase} lm 
            left outer join {local_knowledgebase_read} lmr ON lm.id = lmr.messageid 
    ...
    foreach ($messages as $message) {
        ...
        $DB->insert_record('local_knowledgebase_read', $readrecord);
    }
}
